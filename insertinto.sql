...
((SELECT dog_id FROM Dogs WHERE name = "Clifford"), '2025-06-13 10:30:00', 30, "Croydon", 'completed'),
((SELECT dog_id FROM Dogs WHERE name = "Sam"), '2025-06- 10:30:00', 30, "Croydon", 'open'),
;